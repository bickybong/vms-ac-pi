...
# Gets entrance values and assigns vars based on it
# Checking the timeouts for various variables, and taking different actions depending on whether the timeouts have been reached or not
...
# Check if E1 should be unlocked by E1_is_active and E1_entrance_schedule
...
# infinite loop to check the entrance vars and unlocks the doors
...
def check_gen_pins_and_alarm():
    ...
    def helper(pin, event_trigger):
        ...
        '''
        # helper function to call event_trigger_cb
    ...
    # calling the helper function for the different pins
...
# updating the global variables E1_IN, E1_OUT, E2_IN, and E2_OUT
